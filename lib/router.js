...
// Loopss - 收件箱
router.get('/loopss/:networkId/sms/inbox/:receiver/:channel?', require('./routes/loopss/social-message'));
// Loopss - 发件箱
router.get('/loopss/:networkId/sms/outbox/:sender/:channel?', require('./routes/loopss/social-message'));
// Loopss - 双人对话
router.get('/loopss/:networkId/sms/direct/:sender/:receiver/:channel?', require('./routes/loopss/social-message'));
